...
//             return axios.get('http://localhost:4000/posts');
//         },
//         staleTime: 30000, //by default :0
//         // refetchInterval: 1000,  //by default it remains false and when we switch the tab polling will be stopeed
//         // refetchIntervalInBackground:true  //by this property refetching will be done even if switch in other tabs as well
//         // enabled:false //false to disable automatic refetching when the query mounts or changes query keys
//     })
